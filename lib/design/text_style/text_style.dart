...
class GmTextStyle{
  ...
  static const TextStyle headline1 = TextStyle(
      ...
      fontFamily: GmFontFamily.playfair_display
  );
  ...
  static const TextStyle button = TextStyle(
      ...
      fontWeight: FontWeight.w600,
      letterSpacing: kSpacingButton,fontFamily: GmFontFamily.playfair_display
  );

  static const TextStyle overline = TextStyle(
      fontSize: kSizeOverline,
      fontWeight: FontWeight.w400,
      letterSpacing: kSpacingOverline,fontFamily: GmFontFamily.playfair_display
  );
